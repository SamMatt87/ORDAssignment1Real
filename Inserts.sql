...
5.0, TO_DATE('06/07/2005', 'DD/MM/RRRR'))
(2, 'Mateo', 'Herbert Von Karajan comes to mind. Slow. No sense of the arc of the entire dance, but rather a series of orchestral pieces that are played mostly mezzo forte, with limited drama and zero spontaneity. In sum, the performance fails to realize the composers intentions. I purchased the recording based on the reviews here, but will be giving it away as a gift. I may try again with Bonynges recording, which is said to be more balletic, or continue to look into the more obscure Russian recordings.',
3.0,  TO_DATE('01/07/2010', 'DD/MM/RRRR'))
(3, 'S. Vinokurov', 'Love the CD (it has two rare favs of mine... the faster Black Swan Variation and the extended Russian Dance) however, I was shocked not to find Black Swan Pas de Deux. How can you have a COMPLETE Swan Lake recording and not include that?!?!?!',
4.0, TO_DATE('31/07/2006', 'DD/MM/RRRR'))
), 1, 11.99));
