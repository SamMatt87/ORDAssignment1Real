INSERT INTO ALBUM VALUES(CD_TYPE('ALB1','Tchaikovsky: Swan Lake (Complete Ballet)', 180, 'Classical', TO_DATE('01/06/2004', 'DD/MM/YYYY'),
...
TRACK_TYPE(27,'VI: Tempo Di Valse: Tout Le Monde Danse',180,0.99),
TRACK_TYPE(28,'VII: Coda: Allegro Vivo',180,0.99),
TRACK_TYPE(29,'No.14 - Scene: Moderato',180,0.99),
TRACK_TYPE(30,'No.15 - Scene: Allegro Giusto',180,0.99),
TRACK_TYPE(31,'No.16 - Danse Du Corps De Ballet Et Des Nains: Moderato Assai - Allegro Vivo',180,0.99),
TRACK_TYPE(32,'No.17 - Scene: Sortie Des Invites Et Valse: Allegro - Tempo Di Valse',180,0.99),
TRACK_TYPE(33,'No.18 - Scene: Allegro - Allegro Giusto',180,0.99),
TRACK_TYPE(34,'I: Intrada: Moderato Assai',180,0.99),
TRACK_TYPE(35,'II: Variation I: Allegro',180,0.99),
TRACK_TYPE(36,'III: Variation II: Andante Con Moto',180,0.99),
TRACK_TYPE(37,'IV: Variation III: Moderato',180,0.99),
TRACK_TYPE(38,'V: Variation IV: Allegro',180,0.99),
TRACK_TYPE(39,'VI: Variation V: Moderato - Allegro Semplice',180,0.99),
TRACK_TYPE(40,'VII: Coda: Allegro Molto',180,0.99),
TRACK_TYPE(41,'I: Moderato - Andante - Norman Carol',180,0.99),
TRACK_TYPE(42,'II: Variation I: Allegro Moderato',180,0.99),
TRACK_TYPE(43,'III: Variation II: Allegro',180,0.99),
TRACK_TYPE(44,'III: Coda: Allegro Molto Vivace',180,0.99),
TRACK_TYPE(45,'No.20 - Danse Hongroise - Czardas (Moderato Assai - Allegro Moderato - Vivace',180,0.99),
TRACK_TYPE(46,'Appendix 2: Danse Russe: Moderato - Allegro Semplice - Allegro Vivo - Norman Carol',180,0.99),
TRACK_TYPE(47,'No.21 - Danse Espagnole: Allegro Non Troppo, Tempo Di Bolero',180,0.99),
TRACK_TYPE(48,'No.22 - Danse Napolitaine: Allegro Moderato - Andantino Quasi Moderato - Presto - Frank Kaderbarek',180,0.99),
TRACK_TYPE(49,'No.23 - Mazurka: Solistes Et Corps De Ballet Tempo Di Mazurka',180,0.99),
TRACK_TYPE(50,'No.24 - Scene: Allegro - Valse - Allegro Vivo',180,0.99),
TRACK_TYPE(51,'No.25 - EntrActe: Moderato',180,0.99),
TRACK_TYPE(52,'No.26 - Scene: Allegro Non Troppo',180,0.99),
TRACK_TYPE(53,'No.27 - Danses Des Petits Cygnes: Moderato',180,0.99),
TRACK_TYPE(54,'No.28 - Scene: Allegro Agitato - Molto Meno Mosso - Allegro Vivace',180,0.99),
TRACK_TYPE(55,'No.29 - Scene Finale: Andante - Allegro Agitato - Alla Breve - Moderato',180,0.99)),
REVIEWS_TABLE(
