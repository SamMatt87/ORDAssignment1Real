INSERT INTO ALBUM VALUES(CD_TYPE(1,'Tchaikovsky: Swan Lake (Complete Ballet)(DISC1)', 180, "Classical", 1/6/2004
((1,'Introduction: Moderato Assai - Allegro Ma Non Troppo',180,99,100)
(2,'No.1 - Scene: Allegro Giusto',180,99,100)
(3,'No.2 - Valse: Tempo Di Valse',180,99,100)
(4,'No.3 - Scene: Allegro Moderato',180,99,100)
(5,'I: Intrada: Allegro',180,99,100)
(6,'I: Intrada: Allegro',180,99,100)
(7,'III: Allegro Semplice',180,99,100)
(8,'IV: Moderato',180,99,100)
(9,'V: Allegro',180,99,100)
(10,'VI: Coda: Allegro Vivaceo',180,99,100)
(11,'I: Tempo Di Valse Ma Non Troppo Vivo, Quasi Moderato',180,99,100)
(12,' II: Andante - Allegro - Norman Carol',180,99,100)
(13,'III: Tempo Di Valse',180,99,100)
(14,'IV: Coda: Allegro Molto Vivace',180,99,100)
(15,'No.6 - Pas D Action: Andantino Quasi Moderato - Allegro',180,99,100)
(16,'No.7 - Sujet',180,99,100)
(17,'No.8 - Danse Des Coupes: Tempo Di Polacca',180,99,100)
(18,'o.9 - Finale: Andante',180,99,100)
(19,'No.10 - Scene: Moderato',180,99,100)
(20,'No.11 - Scene: Allegro Moderato - Allegro Vivo',180,99,100)
(21,'No.12 - Scene: Allegro',180,99,100)
(22,'I: Tempo Di Valse',180,99,100)
(23,'II: Moderato Assai - Molto Piu Mosso',180,99,100)
(24,'III: Danses Des Cygnes: Tempo Di Valse',180,99,100)
(25,'IV: Allegro Moderato',180,99,100)
(26,'V: Pas D Action (Odette Et Le Prince): Andante - Andante Non Troppo - Allegro - Norman Carol',180,99,100))
((1,'Rudy Avila','Tchaikovskys Swan Lake remains a ballet favorite and a powerful star vehicle for the prima ballerina who must dance the roles of two characters- the "white swan" Odette and the black swan Odile, good and evil. Swan Lake has been recorded many times by celebrated conductors and their orchestras - Eugene Ormandy and the Philadelphia Orchestra (here its Wolfgang Sawallisch and the same orchestra from an earlier period) Canadian Charles Dutroit and the Montreal forces, Seiji Ozawa, Andre Previn and the London Symphony Orchestra, Richard Bonynge better known for his operatic vehicles with his wife Joan Sutherland, Antal Dorati and his orchestra, and even Herbert Von Karajan joined the band wagon of conducting great ballets- he conducted the complete Giselle and a concert suite of Tchaikovskys Swan Lake, Sleeping Beauty and Nutcracker.
...
5.0, 7/6/2005)
('Mateo', 'Herbert Von Karajan comes to mind. Slow. No sense of the arc of the entire dance, but rather a series of orchestral pieces that are played mostly mezzo forte, with limited drama and zero spontaneity. In sum, the performance fails to realize the composers intentions. I purchased the recording based on the reviews here, but will be giving it away as a gift. I may try again with Bonynges recording, which is said to be more balletic, or continue to look into the more obscure Russian recordings.',
3.0, 7/1/2010)
('S. Vinokurov', 'Love the CD (it has two rare favs of mine... the faster Black Swan Variation and the extended Russian Dance) however, I was shocked not to find Black Swan Pas de Deux. How can you have a COMPLETE Swan Lake recording and not include that?!?!?!',
4.0, 7/31/2006)),
1, 11.99));