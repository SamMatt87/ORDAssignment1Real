...
INSERT INTO ROLE
	SELECT REF(ART), REF(ALB), 'Singer'
	FROM ARTIST ART, TAPE ALB
	WHERE ART.ARTIST_ID = 'ART989' AND (ALB.ALBUM_ID = 'ALB984' OR ALB.ALBUM_ID = 'ALB983');
/
...
INSERT INTO ROLE
	SELECT REF(ART), REF(ALB), 'Singer'
	FROM ARTIST ART, TAPE ALB
	WHERE ART.ARTIST_ID = 'ART996' AND (ALB.ALBUM_ID = 'ALB982', ALB.ALBUM_ID = 'ALB981');
/
...
INSERT INTO ROLE
	SELECT REF(ART), REF(ALB), 'Singer'
	FROM ARTIST ART, TAPE ALB
	WHERE ART.ARTIST_ID = 'ART998' AND (ALB.ALBUM_ID = 'ALB980' OR ALB.ALBUM_ID = 'ALB979');
/
INSERT INTO ROLE
	SELECT REF(ART), REF(ALB), 'Band'
	FROM ARTIST ART, TAPE ALB
	WHERE ART.ARTIST_ID = 'ART997' AND (ALB.ALBUM_ID = 'ALB980' OR ALB.ALBUM_ID = 'ALB979';
/
