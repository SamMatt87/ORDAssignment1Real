...
INSERT INTO ROLE
	SELECT REF(ART), REF(ALB), 'Singer'
	FROM ARTIST ART, VINYL ALB
	WHERE ART.ARTIST_ID = 'ART989' AND (ALB.ALBUM_ID = 'ALB988' OR ALB.ALBUM_ID = 'ALB980';
/
...
INSERT INTO ROLE
	...
	FROM ARTIST ART, VINYL ALB
	WHERE ART.ARTIST_ID = 'ART990' AND (ALB.ALBUM_ID = 'ALB989' OR ALB.ALBUM_ID = 'ALB981';
...
INSERT INTO ROLE
	...
	FROM ARTIST ART, VINYL ALB
	WHERE ART.ARTIST_ID = 'ART994' AND (ALB.ALBUM_ID = 'ALB992' OR ALB.ALBUM_ID = 'ALB982');
...
INSERT INTO ROLE
	SELECT REF(ART), REF(ALB), 'Singer'
	FROM ARTIST ART, VINYL ALB
	WHERE ART.ARTIST_ID = 'ART996' AND (ALB.ALBUM_ID = 'ALB996' OR ALB.ALBUM_ID = 'ALB983');
/
...
INSERT INTO ROLE
	...
	FROM ARTIST ART, VINYL ALB
	WHERE ART.ARTIST_ID = 'ART999' AND (ALB.ALBUM_ID = 'ALB999' OR ALB.ALBUM_ID='ALB984';
/
...
WHERE (VINYL1.ALBUM_ID = 'ALB999' OR VINYL1.ALBUM_ID = 'ALB985') AND VINYL2.ALBUM_ID = 'ALB998'
/