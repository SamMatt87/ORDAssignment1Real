...
/
CREATE TYPE FORMAT_TYPE UNDER ALBUM_TYPE
(ALBUM_FORMAT VARCHAR(5),
/*FORMAT OF THE ALBUM: VINYL, TAPE, CD, OR MP3*/
NEW_OR_USED NUMBER(1),
/*1 FOR NEW, 0 FOR USED (ALL MP3'S MARKED AS NEW)*/
PRICE NUMBER(2,2)
/*ALBUM PRICE IN $*/);
/
