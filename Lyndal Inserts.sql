...
/
INSERT INTO CD VALUES(CD_TYPE('ALB2','Tchaikovsky: Swan Lake', 180, 'Classical', TO_DATE('01/06/2004', 'DD/MM/YYYY'),
...
INSERT INTO ALSO_BOUGHT
	...
	AND SEC_ALB.ALBUM_ID = 'ALB1';
/
--SET ESCAPE '\'

INSERT INTO VINYL VALUES(VINYL_TYPE('ALB3','Tchaikovsky Swan Lake Suite From the Ballet', 55, 'Classical', TO_DATE('24/06/2016', 'DD/MM/YYYY'),
...
REVIEWS_TABLE(REVIEW_TYPE(1, NULL,'tHIS IS BULLSHIT. i THOUGHT i WAS BUYING THE cd',0.0,TO_DATE('30/06/2016', 'DD/MM/YYYY'))), 1, 22.59));
/
...
INSERT INTO ALSO_BOUGHT
	...
	AND SEC_ALB.ALBUM_ID = 'ALB1';
/
INSERT INTO CD VALUES(CD_TYPE('ALB4','Tchaikovsky the Nutcracker Suite From the Ballet', 49, 'Classical', TO_DATE('24/06/2016', 'DD/MM/YYYY'),
...
INSERT INTO ALSO_BOUGHT
	SELECT REF(FIR_ALB), REF(SEC_ALB)
	FROM CD FIR_ALB, VINYL SEC_ALB
	WHERE FIR_ALB.ALBUM_ID = 'ALB4'
	AND SEC_ALB.ALBUM_ID = 'ALB3';
/
INSERT INTO CD VALUES(CD_TYPE('ALB5','The Future', 60, 'Rock', TO_DATE('10/11/1992', 'DD/MM/YYYY'),
